...
public class Model extends Animable {
	...
	public void method470(int i) {
		...
		if (i == -1)
			return;
		FrameReader class36 = FrameReader.method531(i);
		if (class36 == null)
			return;
	...
	public void method471(int ai[], int j, int k) {
		...
		FrameReader class36 = FrameReader.method531(k);
		if (class36 == null)
			return;
	...
	public final void method482(int j, int k, int l, int i1, int j1, int k1) {
		int i = 0;
		int l1 = Texture.centerX;
		int i2 = Texture.centerY;
	...
	public final void method443(int i, int j, int k, int l, int i1, int j1,
		...
		if (i2 > 0 && aBoolean1684) {
			...
			int i6 = anInt1685 - Texture.centerX;
			int k6 = anInt1686 - Texture.centerY;
		...
		int l5 = Texture.centerX;
		int j6 = Texture.centerY;
		int l6 = 0;
		int i7 = 0;
		if (i != 0) {
			l6 = modelIntArray1[i];
	...
	private final void method485(int i) {
		if (anIntArray1640 != null)
			if (anIntArray1640[i] == 65535)
				return;
		int j = Texture.centerX;
		int k = Texture.centerY;
		int l = 0;
