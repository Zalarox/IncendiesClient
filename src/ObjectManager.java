...
label0:
    ...
    public void method175(int y, WorldController worldController, Class11 class11, int j, int z, int x, int i1, int j1) {
		...
		if (j == 22) {
			...
			worldController.method280(z, k2, y, ((Animable) (obj)), byte0, l2, x, i1);
		...
		if (j == 10 || j == 11) {
			...
			if (obj1 != null) {
				...
				if (worldController.method284(l2, byte0, k2, l4, ((Animable) (obj1)), j4, z, i5, y, x, i1) && class46.aBoolean779) {
					Model model;
			...
			if (class46.isUnwalkable && class11 != null)
				class11.method212(class46.aBoolean757, class46.anInt744, class46.anInt761, x, y, j1);
			return;
		}
		if (j >= 12) {
			Object obj2;
			...
			worldController.method284(l2, byte0, k2, 1, ((Animable) (obj2)), 1, z, 0, y, x, i1);
		...
		if (j == 0) {
			...
			worldController.method282(anIntArray152[j1], ((Animable) (obj3)), l2, y, byte0, x, null, k2, 0, z, i1);
			if (j1 == 0) {
			...
			if (class46.isUnwalkable && class11 != null)
				class11.method211(y, j1, x, j, class46.aBoolean757);
		...
		if (j == 1) {
			...
			worldController.method282(anIntArray140[j1], ((Animable) (obj4)), l2, y, byte0, x, null, k2, 0, z, i1);
			if (class46.aBoolean779)
				if (j1 == 0)
					aByteArrayArrayArray134[z][x][y + 1] = 50;
				else if (j1 == 1)
		...
		if (j == 2) {
			...
			worldController.method282(anIntArray152[j1], ((Animable) (obj11)), l2, y, byte0, x, ((Animable) (obj12)), k2, anIntArray152[i3], z, i1);
			if (class46.aBoolean764)
				if (j1 == 0) {
					anIntArrayArrayArray135[z][x][y] |= 0x249;
					anIntArrayArrayArray135[z][x][y + 1] |= 0x492;
		...
		if (j == 3) {
			...
			worldController.method282(anIntArray140[j1], ((Animable) (obj5)), l2, y, byte0, x, null, k2, 0, z, i1);
			if (class46.aBoolean779)
				if (j1 == 0)
					aByteArrayArrayArray134[z][x][y + 1] = 50;
				else if (j1 == 1)
		...
		if (j == 9) {
			...
			worldController.method284(l2, byte0, k2, 1, ((Animable) (obj6)), 1, z, 0, y, x, i1);
			if (class46.isUnwalkable && class11 != null)
				class11.method212(class46.aBoolean757, class46.anInt744, class46.anInt761, x, y, j1);
			return;
		}
		...
		if (j == 4) {
			...
			worldController.method283(l2, y, j1 * 512, z, 0, k2, ((Animable) (obj7)), x, byte0, 0, anIntArray152[j1]);
			return;
		}
		if (j == 5) {
			int i4 = 16;
			...
			worldController.method283(l2, y, j1 * 512, z, anIntArray137[j1] * i4, k2, ((Animable) (obj13)), x, byte0, anIntArray144[j1]  * i4, anIntArray152[j1]);
			return;
		}
		if (j == 6) {
			Object obj8;
			...
			worldController.method283(l2, y, j1, z, 0, k2, ((Animable) (obj8)), x, byte0, 0, 256);
			return;
		}
		if (j == 7) {
			Object obj9;
			...
			worldController.method283(l2, y, j1, z, 0, k2, ((Animable) (obj9)), x, byte0, 0, 512);
			return;
		}
		if (j == 8) {
			Object obj10;
			...
			worldController.method283(l2, y, j1, z, 0, k2, ((Animable) (obj10)), x, byte0, 0, 768);
		}
	}
...
label0:
        {
            Stream stream = new Stream(abyte0); //turns the .dat file into a stream.
            int l1 = -1;
            do
            {
