...
public class RSFontSystem extends DrawingArea {
    ...
    public RSFontSystem(boolean TypeFont, String s, StreamLoader archive) {
    	try {
        ...
        for (int currentCharacter = 0; currentCharacter < string.length(); currentCharacter++) {
            ...
            if (character == 60) {
                ...
                if (startIndex == -1) {
                    ...
                    if (strikethroughColor != -1) {
                    	DrawingArea474.drawHorizontalLine(drawX,
                                                         drawY + (int) ((double) baseCharacterHeight * 0.7),
                                                         i_109_, strikethroughColor);
                    }
                    if (underlineColor != -1) {
                    	DrawingArea474.drawHorizontalLine(drawX, drawY + baseCharacterHeight, i_109_,
                                                         underlineColor);
                    }
                    drawX += i_109_;
                }
