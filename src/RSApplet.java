    ...
    implements Runnable, MouseListener, MouseMotionListener, MouseWheelListener, KeyListener, FocusListener, WindowListener
{
    ...
    public void setCursor(int id) {
    	Image image = getGameComponent().getToolkit().createImage(FileOperations.ReadFile(id == 0 ? 
    			signlink.findcachedir()+"/Cursor 0.PNG" : signlink.findcachedir()+ "Sprites/Cursors/Cursor "+id+".PNG"));
