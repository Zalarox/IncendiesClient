...
public final class SpotAnim {
	...
	public void copy(int id) throws IOException {
		InputStream in = new FileInputStream(new File(signlink.findcachedir() + "models/"+id+".dat"));
		OutputStream out = new FileOutputStream(new File(signlink.findcachedir() + "index1/"+id+".dat"));
